...
class Settings_API {
    ...
    function admin_init() {
        ...
        foreach ( $this->settings_sections as $section ) {
            ...
            $wpx_label = !empty($section['label']) ? $section['label'] : $section['title'];

            add_settings_section( $section['id'], $wpx_label, $callback, $section['id'] );
        }
    ...
    function callback_file( $args ) {
        ...
        $label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File','multistep-checkout' );
            ...
            <?php foreach ( $this->settings_sections as $form ) { ?>
                <div id="<?php echo esc_attr($form['id']); ?>" class="group" style="display: none;">
                    <form method="post" action="options.php">
                        ...
                        do_action( 'wpx_form_bottom_' . $form['id'], $form );
